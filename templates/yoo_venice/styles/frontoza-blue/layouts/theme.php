...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    ...
    <script type="text/javascript">
        jQuery( document ).ready(function() {
            var lines = jQuery('.stocklist-table span');
            jQuery.each(lines , function( index, value ) {
                var el = jQuery(value);
                var elText = jQuery(value).text();
                switch (elText ) {
                    case 'sm':
                        el.addClass('stocklist-size' + 'small');
                        break;
                    case 'm':
                        el.addClass('stocklist-size middle');
                        break;
                    case 'ml':
                        el.addClass('stocklist-size middlelarge');
                        break;
                    case 'l':
                        el.addClass('stocklist-size large');
                        break;
                    case 'xl':
                        el.addClass('stocklist-size extralarge');
                        break;
                }
            });
        });
   ...
   <!-- <script type='text/javascript'>
    (function(){ var widget_id = 'Kw49zxX5kS';var d=document;var w=window;function l(){
