...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    ...
    <script type="text/javascript">
        jQuery( document ).ready(function() {
           jQuery('.jsTableSorter span:contains("F1")').addClass('gen-f1');
           jQuery('.jsTableSorter span:contains("F2")').addClass('gen-f2');
           jQuery('.jsTableSorter span:contains("W")').addClass('gen-w');
       });
   </script>
